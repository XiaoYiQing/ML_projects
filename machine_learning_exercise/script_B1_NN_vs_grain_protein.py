...
'''
This script holds the NN building script to compare grain and protein groups.
'''
...
init_file_names[0] = f"{dirName}\\ML_init_files\\init_food_grains.csv"
...
nut_id_preset = np.array( [ \
    1005, 1009, 1106, 1109, 1170, \
    1004, 1085, 1093, 1100, 1112, 1113, 1114, 1195, 1257, 1258 ] )
