...
'''
This script holds the NN building script to compare veg and grain groups.
'''
...
init_file_names[1] = f"{dirName}\\ML_init_files\\init_food_grains.csv"
...
nut_id_preset = np.array( [ \
    1010, 1012, 1050, 1093, 1094, 1097, 1137, 1146, 1162, \
    1185, 2057, 2069, 1170, \
    1165 ] )
