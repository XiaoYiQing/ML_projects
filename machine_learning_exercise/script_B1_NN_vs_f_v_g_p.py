...
'''
This script holds the NN building script with features that have been used to
determine vegetables, fruits, grains and protein foods
'''
...
nut_id_preset = np.array( [ \
    1002, 1003, 1004, 1005, 1009, 1010, 1011, 1012, 1032, 1137, \
    1039, 1146, 1050, 1071, 1079, 1082, 1084, 1085, 1185, \
    1093, 1094, 1097, 1100, 1105, 1106, 1109, 1112, 1113, 1114, \
    1162, 1165, 1170, 1195, 1253, 1257, 1258, 2057, 2069 \
    ] )
...
model = Sequential(
    [               
        ...
        Dense( 25, activation = "relu", name = "L3", \
            kernel_regularizer=tf.keras.regularizers.l2( reg_factor ) ),
        Dense( 4, activation = "linear", name = "L4" ),
        ### END CODE HERE ### 
    ], name = "my_model"
)
